...
public class Empresa implements Serializable {
    ...
    public Client tornaClient(String numeroDocument) throws NoTrovatException {
        if (llistaClients.containsKey(numeroDocument)) {
            return llistaClients.get(numeroDocument);
        } else {
            throw new NoTrovatException("Aquest client no esta a la llista de clients.");
        }
    }

    public Empleat tornaEmpleat(String numeroDocument) throws NoTrovatException {
        if (llistaEmpleat.containsKey(numeroDocument)) {
            return llistaEmpleat.get(numeroDocument);
        } else {
            throw new NoTrovatException("Aquest empleat no esta a la llista de empleats.");
        }
    }

    public Patro tornaPatro(String numeroDocument) throws NoTrovatException {
        if (llistaPatrons.containsKey(numeroDocument)) {
            return llistaPatrons.get(numeroDocument);
        } else {
            throw new NoTrovatException("Aquest patró no esta a la llista de patrons.");
        }
    }

    public Embarcacio tornaEmbarcacio(Integer numeroSerie) throws NoTrovatException {
        if (llistaEmbarcacions.containsKey(numeroSerie)) {
            return llistaEmbarcacions.get(numeroSerie);
        } else {
            throw new NoTrovatException("Aquesta embarcació no esta a la llista de embarcacions.");
        }
    }

    public Operacio tornaOperacions(Integer numeroSerie) throws NoTrovatException {
        if (llistaOperacions.containsKey(numeroSerie)) {
            return llistaOperacions.get(numeroSerie);
        } else {
            throw new NoTrovatException("Aquesta operació no esta a la llista de operacions.");
        }
    }
}
