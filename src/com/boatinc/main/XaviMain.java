...
public class XaviMain {
     ...
     */
    public static void main(String[] args) throws NoAfegitException, NoEliminatException {
        ...
        /*try{
            ...
            Veler veler2 = new Veler(empresa1,4, 1, 4, 1414, "4422t", "Catamaran", "c42", 6, 14, 2, Proposit.REPARACIO, 100000, true);
            Veler veler3 = new Veler(empresa1,2, 1, 4, 2424, "3399g", "Beneteau", "j64", 4, 12, 2, Proposit.VENTA, 70000, true);
            
            Motor motor1 = new Motor(empresa1,150, 100, true, 9999, "3214m", "Yamaha", "y23", 2, 8, 1, Proposit.LLOGUER, 20000, true);
            Motor motor2 = new Motor(empresa1,400, 300, true, 1111, "1177n", "Raptor", "r98", 2, 10, 1, Proposit.REPARACIO, 30000, true);
            Motor motor3 = new Motor(empresa1,300, 200, true, 2222, "2234w", "Zodiac", "z46", 2, 12, 1, Proposit.VENTA, 25000, true);
